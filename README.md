...
Open [http://localhost:5173](http://localhost:5173). No API keys or database required; it uses free public OpenStreetMap services.
...
- **No route validation.** The app accepts whatever OSRM returns; it never checks the result against the shape it was asked for. Adding that check is a prerequisite for fixing fidelity, because you can't improve what you don't measure.
